...
draft = false
title = 'Mini-projekt 1 - Web stránka'
weight = 2
+++
...
&nbsp;&nbsp;&nbsp;&nbsp;Po vytvorení stránky som určil tému, podľa ktorej bude stránka vyzerať. Následne som upravil kód tak aby stránka mala štruktúru (rôzne menu a podobne). Pridávanie textu a článkov je už celkom jednoduché. Najťažšie bolo všetko správne nastaviť Výsledkom mojej práce je tento web s odkazom: https://268026-oss.github.io/268026_ZPC_2025. Postupne túto stránku budem updatovať s novými článkami s novými mini-projektami.

Fotka ako vyzerá kód vo Visual studio code:
![Visual Studio](/268026_ZPC_2025/images/visualstudio.png)
